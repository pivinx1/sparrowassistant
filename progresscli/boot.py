...
def startup(system):
    from .oses.system95 import launch95
    from .oses.system95plus import launch95plus
    from .oses.system98 import launch98
    from .oses.systemmeme import launchmeme
    from .oses.system2000 import launch2000
    from .oses.systemxb import launchxb
    from .oses.systemwista import launchwista
    if system == "1":
...
def remoteBoot():
    # This function exists so you can remotely start ProgressCLI 95. In this case, from Sparrow.
    boot()
